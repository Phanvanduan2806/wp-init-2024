<?php
// [blog_imports]
function shortcode_latest_from_import($atts, $content = null, $tag = '' ) {
...
// CUSTOM
    ...
    $post_ids = wp_list_pluck($recentPosts, 'ID');
// END-CUSTOM
	$args = array(
        'post__in' => $post_ids,
        'post_status' => 'publish',
...
//var_dump($recentPosts->request);die();
// Get repeater HTML.
...
add_shortcode("blog_imports", "shortcode_latest_from_import");
